    ...
    <Layout>
      ...
      <section className="py-24 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto">EdgeOne's modular architecture is designed to adapt to any mission-critical operational environment.</p>
