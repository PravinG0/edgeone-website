        ...
        <Layout>
            ...
            <Section className="pt-40 pb-24 relative overflow-hidden">
                ...
                <div className="flex flex-col items-start relative z-10">
                    <Link
                        to="/industries"
                        className="flex items-center gap-2 text-sm font-bold text-primary mb-12 hover:opacity-80 transition-opacity uppercase tracking-widest"
                    >
                    ...
                    <h1 className="text-5xl md:text-8xl font-black mb-8 max-w-5xl leading-[1.05] font-outfit">
                        {industry.heroTitle.split(' ').map((word, i) => (
                            i === industry.heroTitle.split(' ').length - 1 ? <span key={i} className="text-gradient">{word}</span> : word + ' '
                        ))}
                    </h1>
            ...
            <Section className="bg-white/[0.02] border-y border-white/5">
                <div className="grid lg:grid-cols-2 gap-20">
                    ...
                    <div className="glass-card rounded-3xl p-10 lg:p-14 relative overflow-hidden">
                        ...
                        <p className="text-zinc-300 mb-10 leading-relaxed text-lg font-medium">
                            {industry.solution}
                        </p>
            ...
            <section className="py-24 text-center">
                <div className="container mx-auto px-4">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <Link to="/contact" className="inline-flex items-center gap-2 rounded-lg bg-primary px-8 py-4 text-base font-semibold text-primary-foreground hover:brightness-110 glow-box transition-all">
                            Talk to an Architect <ArrowRight className="w-5 h-5" />
                        </Link>
                        <Link to="/resources" className="inline-flex items-center gap-2 rounded-lg border border-border px-8 py-4 text-sm font-semibold text-foreground hover:bg-secondary transition-all">
