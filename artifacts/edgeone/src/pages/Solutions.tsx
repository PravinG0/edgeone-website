    ...
    return (
      <div className="relative w-full h-full flex items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-sm aspect-video border border-white/10 rounded-xl overflow-hidden bg-background/50 backdrop-blur-sm shadow-2xl">
          ...
          <div className="absolute inset-0 flex flex-col p-4 space-y-2 opacity-30">
        ...
        <div className="relative w-full max-w-sm aspect-video border border-white/10 rounded-xl overflow-hidden bg-background/50 backdrop-blur-sm flex items-center justify-center">
          ...
          <div className="relative">
            ...
            {[...Array(4)].map((_, i) => (
              <motion.div
                key={i}
                className="absolute top-1/2 left-1/2 w-48 h-0.5 bg-gradient-to-r from-transparent via-primary/40 to-transparent"
                style={{ rotate: i * 45, x: "-50%", y: "-50%" }}
  ...
  return (
    <Layout>
      ...
      {solutions.map((s, i) => (
        <Section
          key={s.title}
          id={["rtls", "monitoring", "healthcare", "edge-ai"][i]}
        ...
        >
          ...
          >
            ...
            <div className={`glass-card rounded-3xl p-4 bg-grid relative overflow-hidden group min-h-[320px] flex items-center justify-center ${i % 2 !== 0 ? "lg:order-1" : ""}`}>
              ...
              <TechVisualization type={["rtls", "monitoring", "healthcare", "edge-ai"][i]} />
            </div>
          </motion.div>
        </Section>
      ))}
      ...
      <section className="py-20 text-center">
        <div className="container mx-auto px-4">
          ...
          <Link to="/contact" className="inline-flex items-center gap-2 rounded-xl bg-primary px-8 py-4 text-sm font-bold text-white hover:brightness-110 glow-box transition-all uppercase tracking-widest">
